...
THM.updateCss = function( link ) {
	...
	themeName = link;
	THMcss.href = link;  // bogus style sheet
...
THM.setTheme = function() {
	...
	THMdivBootswatch.innerHTML = '<p>Themes from <a href="https://bootswatch.com/" target=_blank>Bootswatch</a><br>' + txt1.join( '' );
	...
	THMdivCssOthers.innerHTML = txt + '<p><small>these buttons are work-in-progress WIP</small></p>';
