...
const MNU = { "release": "R13.0", "date": "2018-12-29" };
...
MNU.currentStatus =
	`
		...
		<p><a href="" target="_blank">MNU Read Me</a></p>

		<p>
			Change log
			<ul>
				<li>2018-12-29 ~ first commit</li>
				<!-- <li></li> -->
			</ul>
		</p>
	`;
...
MNU.getNavHeader = function() {
	...
	`
		...
		&raquo;
		<a href="https://www.ladybug.tools/spider-gbxml-tools/" title="Tools to help you find, load, examine and edit gbXML files - in large numbers and sizes" >tooToo</a>
		&raquo;
		</h3>
		<h2>
