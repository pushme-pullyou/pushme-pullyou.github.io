...
THM.themeNameStorage = 'tootooCookbookThemeName';
...
THM.init = function() {
	...
	THM.thmName = localStorage.getItem( THM.themeNameStorage ) || 'THMcssBasic';
...
THM.linksRemove = function() {
	...
	THM.cssBasic.id = 'THMcssBasic';
	
	THMcssBasic.href = THM.stylesheet;
...
THM.loadCssBasic = function() {
	...
	localStorage.setItem( THM.themeNameStorage, 'THMcssBasic' );
...
THM.loadCssW3schools = function() {
	...
	THMcssW3schools.href = THM.thmName;

	THMcssBasic.href = THM.stylesheet;

	THM.toggleTagsClassListW3schools( 'add' );

	localStorage.setItem( THM.themeNameStorage, THM.cssW3Theme.href );
...
THM.setCssBootswatch = function( link ) {
	...
	localStorage.setItem( THM.themeNameStorage, link );
